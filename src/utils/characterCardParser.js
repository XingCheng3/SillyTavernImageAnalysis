...
function convertCharacterBook(characterBook) {
    ...
    characterBook.entries.forEach((entry, index) => {
        ...
        result.entries[normalized.id] = {
            ...
            matchPersonaDescription: normalized.matchPersonaDescription,
            matchCharacterDescription: normalized.matchCharacterDescription,
            matchCharacterPersonality: normalized.matchCharacterPersonality,
            matchCharacterDepthPrompt: normalized.matchCharacterDepthPrompt,
            matchScenario: normalized.matchScenario,
            matchCreatorNotes: normalized.matchCreatorNotes,
